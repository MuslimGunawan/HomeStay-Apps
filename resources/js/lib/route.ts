const routesMap: Record<string, string> = {
    ...
    'admin.reservations.complete': '/admin/reservations/{id}/complete',
    'admin.reservations.extend': '/admin/reservations/{id}/extend',
    ...
    'guest.complaints': '/guest/complaints',
    'guest.complaints.store': '/guest/complaints/store',
    ...
    'host.reservations.complete': '/host/reservations/{id}/complete',
    'host.reservations.extend': '/host/reservations/{id}/extend',
